 ...
 * @lucene.internal
 */
public final class CustomTermScorer extends Scorer {
    ...
    public CustomTermScorer(Weight weight, PostingsEnum postingsEnum, LeafSimScorer docScorer) {
        super(weight);
     ...
     * documents.
     */
    CustomTermScorer(Weight weight, ImpactsEnum impactsEnum, LeafSimScorer docScorer) {
        super(weight);
